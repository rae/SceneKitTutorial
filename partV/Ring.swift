...
class Ring : GameObject {
    private var numberNode: SCNNode!
    ...
    init(number: Int) {
        ...
        numberNode = SCNNode(geometry: text)
        numberNode.eulerAngles = SCNVector3(0, degreesToRadians(value: 180), 0)
        numberNode.scale = SCNVector3(0.7, 0.7, 0.7)
        numberNode.position = SCNVector3(2.0, 4.5, -0.7)
        self.addChildNode(numberNode)
        ...
        numberNode.runAction(SCNAction.repeatForever(action4))
